...
namespace AirlinesPc
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public List<Flight> FlightRoutes = new List<Flight>();
        City helper;
        int currentrow = 0;
        ...
        public void ApiReader()
        {
            ...
            //}
            RestAPIManager restapimanager = new RestAPIManager("https://localhost:7245/");
            MessageBox.Show(restapimanager.GetCity("cities/1").Name);
        ...
        //    cols++;
        //}
        //public void FlightContent(Flight item,int rows)
        //{
        //    int cols = 0;
        //    var label = new Label()
        //    {
        ...
        //    }
        //}
        //public void Details(Flight item, int rows)
        //{
        //    int cols = 0;
        //    var label = new Label()
        //    {
